    ...
    <div class="row">
        <div class="col-md-12 m-2 text-white">
            ...
            <asp:DataList ID="dlContact" runat="server" RepeatColumns="5" OnItemCommand="dlContact_ItemCommand" RepeatDirection="Horizontal" CellPadding="20">
                <ItemTemplate>
                    <asp:Image ID="Image1" runat="server" AlternateText="ContactImg" CssClass="rounded img-fluid"
                        ImageUrl='<%# Eval("ContactImg") != null ? ResolveUrl(Eval("ContactImg").ToString()) : "~/images/default-image.png" %>' Height="150px"/>
                    <br />

                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("ContactName") %>' CssClass="form-label"></asp:Label>
                    <br />
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("ContactNo") %>' CssClass="form-label"></asp:Label>
                    <br />
